...
*/
	var F = {
		...
		sa = {
			...
			AZ: [
				...
				[
					...
					[
						...
						'(\\d{2})(\\d{3})(\\d{2})(\\d{2})',
						'$1 $2 $3 $4',
						['1[28]|2|365|46', '1[28]|2|365|46', '1[28]|2|365(?:[0-46-9]|5[0-35-9])|46'],
						'(0$1)',
					],
			...
			GR: [
				,
				[, , '5005000\\d{3}|8\\d{9,10}|(?:[269]\\d|70)\\d{8}', , , , , , , [10, 11]],
				[
					,
					,
			...
			UY: [
				,
				[, , '4\\d{9}|[249]\\d{7}|(?:[49]\\d|80)\\d{5}', , , , , , , [7, 8, 10]],
	...
	function Sa(a, b, c, d) {
		...
		if (0 <= g) {
			...
			(g = e.g),
				(f = b.search(Aa)),
				0 <= f
					? ((f = b.substring(f)), (f = f.replace(Ca, '')), (h = f.search(Ba)), 0 <= h && (f = f.substring(0, h)))
					: (f = ''),
				g.call(e, f);
		g = e.toString();
		f = g.indexOf(';isub=');
		...
		0 != h
			...
			: (Ka(e),
			  b.g(e.toString()),
			  null != c ? ((h = y(f, 10)), u(g, 1, h)) : d && (delete g.g[6], g.i && delete g.i[6]));
		...
		null != f &&
			...
			2 != a && 4 != a && 5 != a && ((b = e), d && 0 < c.toString().length && u(g, 7, c.toString())));
		d = b.toString();
		a = d.length;
